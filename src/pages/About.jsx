            ...
            <nav className="bg-soft-white shadow-[0_4px_6px_rgba(0,0,0,0.1)] fixed top-0 w-full z-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
                    ...
                    <div className="hidden md:flex space-x-6 items-center">
                        ...
                        <a href="#about" className="text-primary-blue hover:text-accent-cyan font-semibold transition-colors duration-300" onClick={(e) => { e.preventDefault(); scrollToSection('about'); }}>About</a>
                        ...
                        <a href="#contact" className="text-primary-blue hover:text-accent-cyan transition-colors duration-300" onClick={(e) => { e.preventDefault(); scrollToSection('contact'); }}>Contact</a>
                ...
                {isMobileMenuOpen && (
                    <div className="md:hidden bg-soft-white shadow-[0_4px_6px_rgba(0,0,0,0.1)]">
                        <div className="px-4 py-2">
                            ...
                            <a href="#about" className="block py-2 text-primary-blue hover:text-accent-cyan font-semibold transition-colors duration-300" onClick={(e) => { e.preventDefault(); scrollToSection('about'); }}>About</a>
