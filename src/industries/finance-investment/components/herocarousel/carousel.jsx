...
const HeroCarousel = () => {
  ...
  // Finance & Investment themed slides
  const slides = [
    {
      id: 1,
      title: "Secure Your Financial Future",
      subtitle: "Trusted Investment Strategies",
      description: "Empower your wealth with data-driven investment plans crafted by industry experts for sustainable growth.",
    ...
    },
    {
      ...
      subtitle: "Personalized Portfolio Management",
      description: "Tailored solutions designed to maximize returns while minimizing risks in today’s dynamic market environment.",
      buttonText: "Learn More",
      background: "from-blue-700 via-indigo-700 to-blue-900",
      accent: "from-blue-400 to-indigo-600"
    },
    {
      id: 3,
      title: "Insight-Driven Financial Planning",
      subtitle: "Comprehensive Wealth Advisory",
      description: "Navigate complex financial decisions with clarity, leveraging deep market insights and expert guidance.",
      buttonText: "Explore Services",
      background: "from-yellow-600 via-yellow-700 to-yellow-800",
