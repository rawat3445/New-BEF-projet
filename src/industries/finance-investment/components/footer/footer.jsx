...
const Footer = () => {
  ...
  const services = [
    ...
    { name: 'Portfolio Advisory', href: '#portfolio-advisory' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Delivering trusted financial advice and investment strategies to help you achieve your wealth goals and secure your future.
            </p>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <span className="text-gray-300">456 Finance Street, Suite 101, Metropolis, NY 10001</span>
              </div>
              <div className="flex items-center">
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-300">contact@financeinvestment.com</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Subscribe to our newsletter for the latest market insights and investment tips.
            </p>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © {currentYear} Finance & Investment Co. All rights reserved.
            </div>
