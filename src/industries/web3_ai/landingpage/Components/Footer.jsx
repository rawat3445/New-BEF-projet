      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="md:col-span-2 mb-8">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center mb-6">
            ...
            />
            <button className="w-full sm:w-auto bg-gradient-to-r from-green-500 bg-gray-800 border px-4 py-3 text-white rounded-b-lg sm:rounded-r-lg sm:rounded-bl-none hover:from-green-600 hover:to-teal-600 transition-all duration-300">
              Subscribe
            </button>
          </div>
        </div>
