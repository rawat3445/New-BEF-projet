  ...
  const sponsorshipTiers = [
    {
      ...
      description: "Lead the stage at the industry's most anticipated entertainment summit of the year.",
      features: [
    ...
    },
    {
      ...
      description: "Showcase your original IP and creative works to thousands of professionals and fans.",
      features: [
    ...
    },
    {
      ...
      description: "Capture conversations with influencers, producers, and talent on-site.",
      features: [
    ...
    },
    {
      ...
      description: "Amplify event reach through exclusive digital distribution and co-streaming.",
      features: [
    ...
    },
    {
      ...
      description: "Support emerging filmmakers and promote diverse storytelling on the big screen.",
      features: [
    ...
    <section className="py-20 bg-gradient-to-br from-slate-50 via-rose-50 to-pink-50">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-20 bg-white/60 backdrop-blur-sm rounded-3xl p-12 border border-white/20 shadow-xl">
          <h3 className="text-3xl font-bold text-center text-gray-800 mb-8">Additional Sponsor Privileges</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center space-y-4">
              <Award className="h-12 w-12 text-pink-600 mx-auto" />
              <h4 className="text-xl font-semibold text-gray-800">Spotlight Recognition</h4>
              <p className="text-gray-600">Trophy & feature at the closing gala + media spotlight</p>
            </div>
            <div className="text-center space-y-4">
              <Briefcase className="h-12 w-12 text-red-600 mx-auto" />
              <h4 className="text-xl font-semibold text-gray-800">B2B Connect</h4>
              <p className="text-gray-600">One-on-one curated networking with industry leaders</p>
            </div>
            <div className="text-center space-y-4">
              <Users className="h-12 w-12 text-orange-500 mx-auto" />
              <h4 className="text-xl font-semibold text-gray-800">Audience Engagement</h4>
              <p className="text-gray-600">Interactive contests, live polls, and branded audience zones</p>
            </div>
          </div>
        </div>
      </div>
