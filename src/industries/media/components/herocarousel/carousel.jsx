...
const MediaAndEntertainmentCarousel = () => {
  ...
  const slides = [
    {
      ...
      subtitle: "Unlimited Movies & Shows",
      description: "Experience blockbuster movies and award-winning shows anytime, anywhere with our seamless streaming platform.",
      buttonText: "Explore Now",
      background: "from-red-700 via-yellow-600 to-red-500",
      accent: "from-yellow-400 to-red-400",
    },
    {
      id: 2,
      title: "Live Concerts & Events",
      subtitle: "Feel the Music Live",
      description: "Join your favorite artists live from your home with crystal-clear streaming and interactive features.",
      buttonText: "Get Tickets",
      background: "from-purple-700 via-pink-600 to-purple-600",
      accent: "from-pink-400 to-purple-400",
    },
    {
      id: 3,
      title: "Exclusive Originals",
      subtitle: "Stories You Can't Miss",
      description: "Discover original series and films crafted by top creators, available only on our platform.",
      buttonText: "Watch Originals",
      background: "from-blue-700 via-indigo-600 to-blue-500",
...
export default MediaAndEntertainmentCarousel;
