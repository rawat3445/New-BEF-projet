  ...
  const values = [
    {
      ...
      description:
        "We bring ideas to life with stunning visuals, powerful narratives, and immersive experiences.",
    },
    {
      icon: <Star className="h-6 w-6" />,
      title: "Talent-Driven",
      description:
        "We collaborate with top-tier creators, artists, and storytellers to produce memorable content.",
    },
    {
      icon: <Heart className="h-6 w-6" />,
      title: "Audience Focused",
      description:
        "We tailor experiences that deeply resonate with diverse audiences across platforms.",
    },
    {
      icon: <CheckCircle className="h-6 w-6" />,
      title: "Quality Production",
      description:
        "From script to screen, we ensure the highest standards of production and storytelling.",
    },
  ]; */
  return (
