...
const HeroCarousel = () => {
  ...
  const slides = [
    {
      id: 1,
      title: "Innovating Mobility, Redefining Automobiles",
      subtitle: "Smart Transport for a Smarter Future",
      description:
        "Explore the world of smart vehicles, sustainable transport, and the future of mobility.",
      buttonText: "Get Started",
      background: "from-blue-950 via-blue-800 to-blue-300", 
      accent: "from-blue-700 to-blue-400",
    },
    {
      id: 2,
      title: "Driving Sustainable Innovation",
      subtitle: "Eco-Friendly, Tech-Forward",
      description:
        "Discover electric, autonomous, and connected vehicles driving the next era of mobility.",
      buttonText: "Learn More",
      background: "from-emerald-900 via-blue-700 to-sky-300", 
      accent: "from-emerald-600 to-blue-400", 
    },
    {
      id: 3,
      title: "Connected Vehicles, Connected Future",
      subtitle: "Seamless Mobility Experiences",
      description:
        "Experience how technology is reshaping transportation through smart connectivity and design.",
      buttonText: "Explore Now",
      background: "from-indigo-900 via-purple-700 to-sky-300", 
      accent: "from-purple-600 to-sky-400", 
    },
  ];
  ...
  return (
    <section className="relative h-screen overflow-hidden bg-gray-900">
      ...
      <div
        className={`absolute inset-0 bg-gradient-to-br ${currentSlideData.background} transition-all duration-1000 ease-in-out`}
      >
        ...
        <div className="container mx-auto px-6 text-center text-white">
          <div className="max-w-5xl mx-auto">
            <div key={currentSlide} className="space-y-6">
              ...
              <div
                className={`w-24 h-1 bg-gradient-to-r ${currentSlideData.accent} mx-auto animate-fade-in opacity-0 delay-200`}
              ></div>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex space-x-4 z-20">
        {slides.map((_, index) => (
          ...
          >
            {index === currentSlide && (
              <div
                className={`absolute inset-0 bg-gradient-to-r ${currentSlideData.accent} animate-pulse-slow`}
              ></div>
            )}
          </button>
        ))}
