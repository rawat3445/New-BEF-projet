  ...
  const pricingPlans = [
    {
      ...
      price: '₹4,999',
      period: '/month',
      description: 'Perfect for small farms looking to get started with smart farming.',
      features: [
    ...
    },
    {
      ...
      price: '₹9,999',
      period: '/month',
      description: 'Ideal for medium to large farms aiming for precision agriculture.',
      features: [
    ...
    },
    {
      ...
      price: 'Custom',
      period: '',
      description: 'Tailored solutions for large agribusinesses and cooperatives.',
      features: [
       ...
       <div className="text-center mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {pricingPlans.map((plan, index) => (
            <div
              key={index}
              className={`relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 ${plan.highlighted ? 'border-2 border-green-500 scale-105' : ''
                }`}
            >
              {plan.highlighted && (
              ...
              <div className={`bg-gradient-to-r ${plan.accent} text-white p-4 rounded-xl w-fit mb-6`}>
                {plan.icon}
              </div>
