            ...
            <div className="px-2 pt-2 pb-6 space-y-2 glass-effect border-t border-gray-100 rounded-b-2xl mt-2 mx-4 shadow-xl">
              {navItems.map((item) => (
                <a
                  ...
                  className={`block px-4 py-3 rounded-xl text-base font-semibold transition-all duration-300 hover:bg-gradient-to-r hover:from-green-50 hover:to-teal-50 hover:scale-105 ${activeSection === item.id ? 'text-green-600 bg-gradient-to-r from-green-50 to-teal-50' : 'text-gray-700 hover:text-green-600'}`}
                >
                  {item.name}
                </a>
              ))}
              ...
              <div className="pt-2 border-t border-gray-100 mt-4">
                ...
                {solutionsItems.map((solution, index) => (
                  <a
                    ...
                    href={solution.href}
                    onClick={() => setIsOpen(false)}
                    className="flex items-center px-6 py-3 rounded-xl text-gray-700 hover:text-green-600 hover:bg-gradient-to-r hover:from-green-50 hover:to-teal-50 transition-all duration-300 group"
                  >
              ...
              <div className="pt-4">
                <a
                  href="#contact"
                  onClick={() => setIsOpen(false)}
                  className="flex items-center justify-center bg-gradient-to-r from-green-500 to-teal-600 text-white px-6 py-4 rounded-xl text-base font-bold transition-all duration-300 hover:scale-105 hover:shadow-lg mx-2"
                >
