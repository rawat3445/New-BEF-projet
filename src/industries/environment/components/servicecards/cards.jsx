...
const SponsorshipBenefits = () => {
  const sponsorshipTiers = [
    {
      ...
      description: "Lead the movement toward a greener future by driving large-scale impact initiatives.",
      features: [
    ...
    },
    {
      ...
      description: "Champion the principles of reuse, recycling, and regeneration at the event.",
      features: [
    ...
    },
    {
      ...
      description: "Support and promote clean, renewable energy solutions to a wide audience.",
      features: [
    ...
    },
    {
      ...
      description: "Back breakthrough ideas and startups working on climate resilience.",
      features: [
    ...
    },
    {
      ...
      description: "Support sustainable water practices and conservation awareness campaigns.",
      features: [
    ...
    },
    {
      ...
      subtitle: "Eco Ally",
      description: "Protect natural ecosystems and educate attendees about biodiversity.",
      features: [
  ...
  return (
    <section id="services" className="py-20 bg-gradient-to-br from-slate-50 via-green-50 to-emerald-50">
      <div className="container mx-auto px-4">
            ...
            >
              ...
              <div className="p-8">
                ...
                <div className="text-3xl font-bold text-gray-800 mb-8 text-center">
                  {tier.price}
                  <div className="text-sm font-normal text-gray-500 mt-1">Contribution</div>
                </div>
        ...
        <div className="mt-20 bg-white/60 backdrop-blur-sm rounded-3xl p-12 border border-white/20 shadow-xl">
          <h3 className="text-3xl font-bold text-center text-gray-800 mb-8">Why Partner With Us?</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center space-y-4">
              <Award className="h-12 w-12 text-green-600 mx-auto" />
              <h4 className="text-xl font-semibold text-gray-800">Green Recognition</h4>
              <p className="text-gray-600">Receive special honors for your sustainable contributions</p>
            </div>
            <div className="text-center space-y-4">
              <Briefcase className="h-12 w-12 text-blue-600 mx-auto" />
              <h4 className="text-xl font-semibold text-gray-800">Eco Market Access</h4>
              <p className="text-gray-600">Connect with buyers and partners in green industries</p>
            </div>
            <div className="text-center space-y-4">
              <Target className="h-12 w-12 text-emerald-600 mx-auto" />
              <h4 className="text-xl font-semibold text-gray-800">ESG Impact</h4>
              <p className="text-gray-600">Boost your Environmental, Social & Governance goals</p>
            </div>
          </div>
        </div>
