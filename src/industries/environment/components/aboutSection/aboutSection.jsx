  ...
  const values = [
    {
      ...
      description:
        "We champion long-term solutions that protect our planet for future generations.",
    },
    {
      icon: <Target className="h-6 w-6" />,
      title: "Action-Oriented",
      description:
        "From planting trees to climate education, we take real-world action to drive change.",
    },
    {
      icon: <Heart className="h-6 w-6" />,
      title: "Community Focus",
      description:
        "We empower local communities to lead environmental change through education and support.",
    },
    {
      icon: <CheckCircle className="h-6 w-6" />,
      title: "Transparency",
      description:
        "We maintain open, honest communication and report our environmental progress clearly.",
    },
  ]; */
  return (
