...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { name: 'Services', href: '#services', id: 'services' }, // changed name
    { name: 'About', href: '#about', id: 'about' },
  ];

  const servicesItems = [
    { name: 'Facial Treatments', href: '#facial', icon: '💆‍♀️', description: 'Rejuvenate your skin naturally' },
    { name: 'Body Therapy', href: '#body', icon: '🧖‍♀️', description: 'Relaxing full-body treatments' },
    { name: 'Aromatherapy', href: '#aroma', icon: '🌿', description: 'Healing through natural scents' },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex-shrink-0 group">
              <h1 className="text-2xl lg:text-3xl font-black bg-gradient-to-r from-pink-500 via-rose-400 to-purple-500 bg-clip-text text-transparent hover:scale-105 transition-all duration-300 logo-glow cursor-pointer">
                BEF Beauty & Wellness
              </h1>
