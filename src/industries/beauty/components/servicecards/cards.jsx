...
const BeautyWellnessSponsorship = () => {
  const sponsorshipTiers = [
    {
      ...
      description: "Exclusive branding and premium presence at the foremost beauty & wellness expo.",
      features: [
  ...
  return (
    <section id="services" className="py-20 bg-gradient-to-br from-pink-50 via-rose-50 to-purple-50">
        ...
        <div className="mt-20 bg-white/60 backdrop-blur-sm rounded-3xl p-12 border border-white/20 shadow-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-600">Special ceremonies and certificates celebrating your brand</p>
            </div>
            <div className="text-center space-y-4">
              <Briefcase className="h-12 w-12 text-purple-600 mx-auto" />
              <h4 className="text-xl font-semibold text-gray-800">Business Growth</h4>
              <p className="text-gray-600">Access to exclusive networking and potential partnerships</p>
            </div>
            <div className="text-center space-y-4">
