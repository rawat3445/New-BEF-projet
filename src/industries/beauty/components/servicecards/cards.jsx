...
const BeautyWellnessSponsorship = () => {
  const sponsorshipTiers = [
    {
      ...
      description:
        "Exclusive branding and premium presence at the foremost beauty & wellness expo.",
      features: [
    ...
    },
    {
      ...
      description:
        "Showcase your brand's leadership in beauty trends and wellness innovations.",
      features: [
    ...
    },
    {
      ...
      description:
        "Connect with industry professionals through workshops and sessions.",
      features: [
    ...
    },
    {
      ...
      description:
        "Highlight your cutting-edge products and wellness tech innovations.",
      features: [
    ...
    },
    {
      ...
      description:
        "Facilitate networking and community engagement for wellness professionals.",
      features: [
    ...
    },
    {
      ...
      description:
        "Maximize your brand reach with exclusive media and digital coverage.",
      features: [
  ...
  return (
    <section
      id="services"
      className="py-20 bg-gradient-to-br from-pink-50 via-rose-50 to-purple-50"
    >
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full border border-pink-200 mb-6">
            ...
            <span className="text-pink-700 font-semibold">Viksit Bharat Conclave 2025</span>
          </div>
          <h2 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-pink-700 via-rose-600 to-purple-800 bg-clip-text text-transparent mb-6">
           Partnership Opportunities
          </h2>
          <p className="text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed">
            Partner with India’s premier beauty and wellness gathering. Elevate your brand while connecting with industry leaders, innovators, and wellness enthusiasts.
          </p>
        </div> */}
        ...
        <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-8 mb-16 border border-white/20 shadow-xl">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
            <div className="space-y-2">
              <div className="text-3xl font-bold text-pink-700">1000+</div>
              <div className="text-gray-600">Beauty Professionals</div>
            </div>
            <div className="space-y-2">
              <div className="text-3xl font-bold text-purple-700">70+</div>
              <div className="text-gray-600">Workshops & Sessions</div>
            </div>
            <div className="space-y-2">
              <div className="text-3xl font-bold text-green-600">35+</div>
              <div className="text-gray-600">Media & Influencer Partners</div>
            </div>
            <div className="space-y-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-600">
                Special ceremonies and certificates celebrating your brand
              </p>
            </div>
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-600">
                Access to exclusive networking and potential partnerships
              </p>
            </div>
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-600">
                Showcase your brand to a worldwide audience through digital
                channels
              </p>
            </div>
          </div>
...
export default BeautyWellnessSponsorship;
