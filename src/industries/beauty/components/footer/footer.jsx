...
const Footer = () => {
  ...
  const services = [
    ...
    { name: 'Manicure & Pedicure', href: '#mani-pedi' },
    { name: 'Wellness Programs', href: '#wellness' },
    { name: 'Skin Treatments', href: '#skin' }
  ];
  ...
  return (
    <footer className="bg-gray-900 text-white relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <h3 className="text-2xl font-bold bg-gradient-to-r from-pink-400 to-purple-500 bg-clip-text text-transparent mb-4">
              BEF Beauty And Wellness
            </h3>
            <p className="text-gray-300 mb-6 leading-relaxed">
              Enhancing your natural beauty and wellness with personalized care and luxurious treatments.
            </p>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <span className="text-gray-300">456 Beauty Blvd, Glamour City, CA 90210</span>
              </div>
              <div className="flex items-center">
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-300">contact@glowwell.com</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Subscribe to our newsletter for beauty tips, wellness advice, and exclusive offers.
            </p>
            ...
            <div className="flex mb-6">
              ...
              />
              <button className="bg-gradient-to-r from-pink-500 to-purple-600 px-4 py-3 rounded-r-lg hover:from-pink-600 hover:to-purple-700 transition-all duration-300">
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social, index) => (
                  <a
                    key={index}
                    href={social.href}
                    className="bg-gray-800 hover:bg-gradient-to-r hover:from-pink-500 hover:to-purple-600 p-3 rounded-lg transition-all duration-300 transform hover:scale-110"
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © {currentYear} BEF Beauty And Wellness. All rights reserved.
            </div>
      ...
      <button
        onClick={scrollToTop}
        className="absolute bottom-6 right-6 bg-gradient-to-r from-pink-500 to-purple-600 text-white p-3 rounded-full shadow-lg hover:from-pink-600 hover:to-purple-700 transition-all duration-300 transform hover:scale-110"
