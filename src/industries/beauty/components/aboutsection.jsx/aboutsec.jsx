        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div>
            ...
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
              Radiance Beauty & Wellness is dedicated to enhancing your natural
              beauty and promoting holistic well-being. Our expert team blends
              the art of beauty with science-backed wellness techniques to help
              you look and feel your best.
            </p>
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              For over 15 years, we've been providing personalized treatments
              and luxurious experiences that nurture your mind, body, and soul.
            </p>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center">
                ...
                <span className="text-gray-700">
                  Award-winning beauty treatments
                </span>
              </div>
              <div className="flex items-center">
                <CheckCircle className="h-5 w-5 text-pink-500 mr-3" />
              ...
              <div className="flex items-center">
                <CheckCircle className="h-5 w-5 text-pink-500 mr-3" />
                <span className="text-gray-700">
                  Expert therapists and consultants
                </span>
              </div>
            </div>
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-pink-500 to-purple-600 rounded-3xl p-8 text-white">
              ...
              <p className="text-lg leading-relaxed mb-6">
                To inspire confidence and well-being through innovative beauty
                treatments and holistic wellness, creating radiant, healthy
                lifestyles.
              </p>
        ...
        <div>
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              These principles guide us to provide exceptional care and beauty
              services that make you shine inside and out.
            </p>
          </div>
