...
const WomenEntrepreneurshipSponsorship = () => {
  const sponsorshipTiers = [
    {
      ...
      description: "Exclusive branding and premier presence at the leading Women Entrepreneurship Summit.",
      features: [
    ...
    },
    {
      ...
      description: "Showcase your brand’s commitment to fostering women-led innovation and business growth.",
      features: [
    ...
    },
    {
      ...
      description: "Engage directly with women entrepreneurs through workshops and panel discussions.",
      features: [
    ...
    },
    {
      ...
      description: "Highlight your cutting-edge solutions supporting women entrepreneurs and startups.",
      features: [
    ...
    },
    {
      ...
      subtitle: "Connector",
      description: "Facilitate networking and community building for women entrepreneurs and allies.",
      features: [
    ...
    },
    {
      ...
      description: "Amplify your brand reach through exclusive media and digital coverage focusing on women entrepreneurship.",
      features: [
  ...
  return (
    <section id="services" className="py-20 bg-gradient-to-br from-blue-50 via-cyan-50 to-indigo-50">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed">
            Partner with India’s leading summit for Women Entrepreneurship. Empower women leaders, foster innovation, and grow your brand by connecting with entrepreneurs, investors, and change-makers.
          </p>
        </div>
