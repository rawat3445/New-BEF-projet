          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-600">
                Special ceremonies and certificates honoring your commitment to
                women entrepreneurs
              </p>
            </div>
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-600">
                Connect with startups, investors, and corporate partners for
                mutual growth
              </p>
            </div>
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-600">
                Customized campaigns to highlight your brand across diverse
