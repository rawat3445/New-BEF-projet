        ...
        <div>
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-700 max-w-2xl mx-auto">
              These principles guide us in nurturing the success, creativity, and independence of women entrepreneurs worldwide.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {values.map((value, index) => (
              <div key={index} className="bg-white bg-opacity-60 rounded-2xl p-8 shadow hover:shadow-lg transition-all duration-300">
