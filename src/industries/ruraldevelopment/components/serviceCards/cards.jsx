        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full border border-green-200 mb-6">
            ...
            <span className="text-green-700 font-semibold">
              Bharat Economic Forum Industry Conclave 2025
            </span>
          </div>
          ...
          <p className="text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed">
            Partner with India's premier platform for rural transformation.
            Align your brand with the vision of a Viksit Bharat by 2047 through
            infrastructure, technology, and community development.
          </p>
        </div> */}
