...
const Footer = () => {
  ...
  const services = [
    { name: 'E-commerce Development', href: '#digital' },
    { name: 'Marketplace Onboarding', href: '#creative' },
    { name: 'Omnichannel Integration', href: '#strategy' },
    { name: 'Inventory Management', href: '#development' },
    { name: 'Product Recommendations', href: '#social' },
    { name: 'Customer Analytics', href: '#analytics' }
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              This is where local meets global, digital meets physical, and consumers meet convenience.
            </p>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © {currentYear} RECommerce Connect. All rights reserved.
            </div>
