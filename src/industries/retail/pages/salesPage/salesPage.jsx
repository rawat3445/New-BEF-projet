        ...
        <div className="sales-container">
          <div className="hero-content">
            ...
            <h1 className="hero-title">
              ...
              <span className="gradient-text">From Click to Cart, and Beyond</span>
            </h1>
            <p className="hero-description">
              The journey from discovery to delivery is crucial. Our comprehensive suite of services optimizes every touchpoint, ensuring a smooth, engaging, and efficient experience for your customers. Minimize friction, maximize conversions, and gain actionable insights that drive continuous improvement across your entire retail and e-commerce ecosystem.
            </p>
